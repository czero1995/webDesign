			...
			<div class="container">
				...
				<div class="content inlinkFlex-spacebetween">
					<div class="goods-item inlinkFlex" v-for="gooditem in goodsList">
						<div class="goodsBox">
							<a :href="'../module/detail.html?id='+gooditem.id">
							...
							<div class="goods-cartBox">
								<img src="../../common/img/icon/shop_addCart.png" @click="onAddCart(gooditem.id,gooditem.goods_name)" />
							</div>
						</div>
...
import {path} from'common/js/http.js'
  	...
  	data() {
				...
				methods: {
					...
					getBannerList: function() {
						const that = this;
						axios.post('http://api.jimuapi.com/wx/banner/getBannerList', {}).then(function(res) {
