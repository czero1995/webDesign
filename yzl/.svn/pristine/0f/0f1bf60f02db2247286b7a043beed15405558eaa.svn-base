...
class Course extends Model
{
    ...
    public function get_course_info($id)
    {
        ...
        return $this->alias('a')
            ->where($map)
            ->field('a.id, a.title, a.sub_title, a.price, a.intro, a.post, a.spost, b.title as tags')
    ...
    public function getCourseList(){
        ...
        $sql = "SELECT a.*, b.title as cate_name FROM course a LEFT JOIN course_category b ON b.id = a.cate_id where $wherestr ORDER BY a.id DESC $limit";
